 ...
 * 
 * STUDENT NAME: Hassinullah Niazy
 * Student ID: 002261956
 */
...
var database = "niazy27";   //database name
var user = "niazy27";       //username (change to match your db)
var password = "JNFDONOEIQY";      //password (change to match your db, yes this is very poor practice)
